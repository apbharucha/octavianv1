...
- Your response would just be "yeah"or "nice"- The conversation is flowing fine without you
...
- **Discord links:** Wrap multiple links in `<>`to suppress embeds: `<https://example.com>`- **WhatsApp:** No headers — use **bold** or CAPS for emphasis
